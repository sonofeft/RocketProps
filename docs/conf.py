...
# -*- coding: utf-8 -*-
#
# RocketProps documentation build configuration file, created by
...
target_file = os.path.join( up_one, 'rocketprops','_version.py')
...
html_logo = "./_static/rocketprops_logo.svg"
...
htmlhelp_basename = 'RocketPropsdoc'
...
latex_documents = [
  (master_doc, 'RocketProps.tex', u'RocketProps Documentation',
...
man_pages = [
    (master_doc, 'projectabcxyz', u'RocketProps Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'RocketProps', u'RocketProps Documentation',
   author, 'RocketProps', 'One line description of project.',
   'Miscellaneous'),
]
